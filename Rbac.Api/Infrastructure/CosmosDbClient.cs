...
public class CosmosDbClient(Database database, string collectionName) : ICosmosDbClient
{
    private readonly Container _container = database.GetContainer(collectionName);
